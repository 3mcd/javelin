(function (global, factory) {
    ...
    function createQuery(...selector) {
        ...
        const forEach = (iteratee) => {
            var _a;
            const context = (_a = query.context) !== null && _a !== void 0 ? _a : UNSAFE_internals.__CURRENT_WORLD__;
            assert(context !== null && context !== -1, ERROR_MSG_UNBOUND_QUERY, ErrorType.Query);
        ...
        query[Symbol.iterator] = () => {
            ...
            const context = (_a = query.context) !== null && _a !== void 0 ? _a : UNSAFE_internals.__CURRENT_WORLD__;
            assert(context !== null && context !== -1, ERROR_MSG_UNBOUND_QUERY, ErrorType.Query);
            const iterator = (recordsIndex[context] || registerWorld(context))[Symbol.iterator]();
            return iterator;
        };
        return query;
    }
        ...
        return function useMonitor(query, onEnter, onExit) {
            ...
            if (onEnter !== undefined) {
                for (let i = 0; i < readyEnter.length; i++) {
                    ...
                    if (query.get(entity, tmpComponents)) {
                        onEnter(readyEnter[i], tmpComponents);
                    }
                }
            }
            if (onExit !== undefined) {
