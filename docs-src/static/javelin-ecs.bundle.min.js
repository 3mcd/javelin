(function (global, factory) {
    ...
    const attached = createComponentFilter(() => ({ cst }) => cst === exports.ComponentState.Attaching);

    const changed = createComponentFilter(() => (c, { isComponentChanged }) => isComponentChanged(c));

    const detached = createComponentFilter(() => ({ cst }) => cst === exports.ComponentState.Detached);
    ...
    class QueryIterable {
        ...
        visitNextArchetype() {
            ...
            outer: while ((this.currentArchetype = world.storage.archetypes[++this.archetypeIndex])) {
        ...
        visitNextEntity() {
            var _a, _b;
            const { currentArchetype, readIndices, componentFilterPredicates, world, } = this;
            ...
            outer: while (++this.entityIndex < length) {
                ...
                for (let i = 0; i < this.queryLength; i++) {
                    ...
                    if ((_b = (_a = componentFilterPredicates[i]) === null || _a === void 0 ? void 0 : _a.call(componentFilterPredicates, component, world)) !== null && _b !== void 0 ? _b : component.cst === 2) {
    ...
    function query(...selector) {
        const pool = createStackPool(() => new QueryIterable(selector), q => {
            q.reset();
            return q;
        }, 100);
        return (world) => {
