(function (global, factory) {
    ...
    (function (SchemaKeyKind) {
        SchemaKeyKind[SchemaKeyKind["Array"] = 0] = "Array";
        SchemaKeyKind[SchemaKeyKind["Map"] = 1] = "Map";
        SchemaKeyKind[SchemaKeyKind["Primitive"] = 2] = "Primitive";
    ...
    const modelChanged = createSignal();

    const $type = Symbol("javelin_component_type");
    ...
    const component = (componentType) => {
        ...
        return componentTypePools.get(componentType[$type]).retain();
    };
    ...
    function createQuery(...selector) {
        ...
        const forEach = (iteratee) => {
            const records = recordsByWorldId[globals.__CURRENT_WORLD__] ||
